...
#define POSTION_Record_Time_X			200+45
#define POSTION_Record_Time_Y			5

#if (TV_WIDTH == 720)
#define POSTION_Record_Time_X_tv		615
#elif(TV_WIDTH == 640)
#define POSTION_Record_Time_X_tv		560
#endif

#define POSTION_Record_Time_Y_tv		30

#define C_ICON_HDMI_OFFSET 	30

#define POSTION_Date_Time_Record_X		100-20
#define POSTION_Date_Time_Record_Y		210
